...
with st.sidebar:
    ...
    st.info("🚀 **Motor:** Gemini 2.0 Flash\n(Última generación)")
...
try:
    ...
    # --- ¡AQUÍ ESTÁ EL CAMBIO MAESTRO! Usamos el modelo que SÍ tienes ---
...
if len(st.session_state.messages) == 0:
    st.chat_message("assistant").write("¡Hola compañero! 👷 Soy tu Asesor Virtual CATEM con tecnología Gemini 2.0. ¿En qué puedo ayudarte hoy? (Ej. Despido injustificado, dudas de aguinaldo, acoso laboral...)")
